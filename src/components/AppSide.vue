...
<template>
  ...
  <aside
    ...
    class="bg-sky-900 text-white fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
    aria-label="Sidebar"
  >
    <div class="h-full px-3 py-4 overflow-y-auto bg-sky-900 text-white">
      <ul class="space-y-2 font-medium text-white">
        ...
        <li>
          <div href="#" class="flex items-center p-2 rounded-lg">
            <svg
              class="flex-shrink-0 w-5 h-5 transition duration-75"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
